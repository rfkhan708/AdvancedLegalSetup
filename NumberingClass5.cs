...
{
   public class NumberingClass5
    {
        private static NumberingClass5 instance = null;
        private NumberingClass5()
        {
        }
        public static NumberingClass5 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass5();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[2].NumberStyle = WdListNumberStyle.wdListNumberStyleLowercaseLetter;
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[2].NumberPosition = appWord.InchesToPoints(1.5f);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[2].TabPosition = appWord.InchesToPoints(2);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[2].Font.Animation = (WdAnimation)WdConstants.wdUndefined;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].NumberStyle = WdListNumberStyle.wdListNumberStyleLowercaseRoman;
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].NumberPosition = appWord.InchesToPoints(2);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].TabPosition = appWord.InchesToPoints(2.5f);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].NumberPosition = appWord.InchesToPoints(2.5f);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].TabPosition = appWord.InchesToPoints(3);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[5].NumberPosition = appWord.InchesToPoints(2.5f);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[5].TabPosition = appWord.InchesToPoints(3);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[6].TrailingCharacter = WdTrailingCharacter.wdTrailingNone;
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[6].NumberStyle = WdListNumberStyle.wdListNumberStyleNone;
