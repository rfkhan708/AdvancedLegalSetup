...
{
    public class NumberingClass8
    {
        private static NumberingClass8 instance = null;
        private NumberingClass8()
        {
        }
        public static NumberingClass8 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass8();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].NumberStyle = WdListNumberStyle.wdListNumberStyleUppercaseLetter;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[5].NumberStyle = WdListNumberStyle.wdListNumberStyleLowercaseLetter;
