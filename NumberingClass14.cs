...
{
    public class NumberingClass14
    {
        private static NumberingClass14 instance = null;
        private NumberingClass14()
        {
        }
        public static NumberingClass14 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass14();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[1].NumberPosition = appWord.InchesToPoints(0.5f);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].TrailingCharacter = WdTrailingCharacter.wdTrailingSpace;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].TrailingCharacter = WdTrailingCharacter.wdTrailingSpace;
