...
{
    public class NumberingClass2
    {
        private static NumberingClass2 instance = null;
        private NumberingClass2()
        {
        }
        public static NumberingClass2 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass2();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                //_with1 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading2];
                appWord.ActiveDocument.Paragraphs.Alignment = WdParagraphAlignment.wdAlignParagraphJustify;
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                setStyle = "Body Text";
                ...
                //_with1 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading3];
                appWord.ActiveDocument.Paragraphs.Alignment = WdParagraphAlignment.wdAlignParagraphJustify;
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                setStyle = "Body Text";
                ...
                //_with1 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading4];
                appWord.ActiveDocument.Paragraphs.Alignment = WdParagraphAlignment.wdAlignParagraphJustify;
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                setStyle = "Body Text";
                ...
                // _with1 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading5];
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].NumberFormat = "%1.%2.%3.%4";
