...
{
    public class NumberingClass10
    {
        private static NumberingClass10 instance = null;
        private NumberingClass10()
        {
        }
        public static NumberingClass10 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass10();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[1].NumberFormat = "%1.%1";
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[2].NumberFormat = "%1.%1.%1.";
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].NumberFormat = "%5";
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[5].NumberFormat = "(%6)";
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[6].NumberFormat = "%7";
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[7].NumberFormat = "%8";
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[8].NumberFormat = "%9";
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[9].NumberFormat = "%10.";
