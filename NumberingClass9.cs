...
{
    public class NumberingClass9
    {
        private static NumberingClass9 instance = null;
        private NumberingClass9()
        {
        }
        public static NumberingClass9 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass9();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].TextPosition = appWord.InchesToPoints(1);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].TextPosition = appWord.InchesToPoints(1.5f);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[5].TextPosition = appWord.InchesToPoints(2);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[6].TextPosition = appWord.InchesToPoints(3);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[7].TextPosition = appWord.InchesToPoints(3);
