...
{
   public class NumberingClass4
    {
        private static NumberingClass4 instance = null;
        private NumberingClass4()
        {
        }
        public static NumberingClass4 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass4();
                }
                return instance;
            }
        }
