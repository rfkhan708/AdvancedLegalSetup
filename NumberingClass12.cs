...
{
    public class NumberingClass12
    {
        private static NumberingClass12 instance = null;
        private NumberingClass12()
        {
        }
        public static NumberingClass12 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass12();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[1].NumberFormat = "Article %1.";
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[1].TrailingCharacter = WdTrailingCharacter.wdTrailingNone;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[2].NumberPosition = appWord.InchesToPoints(0);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].NumberPosition = appWord.InchesToPoints(0.5f);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].TextPosition = appWord.InchesToPoints(0.5f);
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].TabPosition = appWord.InchesToPoints(1);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].TextPosition = appWord.InchesToPoints(1);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[5].NumberPosition = appWord.InchesToPoints(1.5f);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[5].TextPosition = appWord.InchesToPoints(1.5f);
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[5].TabPosition = appWord.InchesToPoints(2);
