...
{
   public class NumberingClass6
    {
        private static NumberingClass6 instance = null;
        private NumberingClass6()
        {
        }
        public static NumberingClass6 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass6();
                }
                return instance;
            }
        }
