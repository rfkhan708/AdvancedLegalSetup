...
{
    public class NumberingClass16
    {
        private static NumberingClass16 instance = null;
        private NumberingClass16()
        {
        }
        public static NumberingClass16 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass16();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading2].Font.AllCaps = (int)GlobalEnumClass.AllEnum.True;
