...
{
    public class NumberingClass19
    {
        private static NumberingClass19 instance = null;
        private NumberingClass19()
        {
        }
        public static NumberingClass19 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass19();
                }
                return instance;
            }
        }
