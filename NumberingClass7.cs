...
{
    public class NumberingClass7
    {
        private static NumberingClass7 instance = null;
        private NumberingClass7()
        {
        }
        public static NumberingClass7 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass7();
                }
                return instance;
            }
        }
