...
{
    public class NumberingClass3
    {
        private static NumberingClass3 instance = null;
        private NumberingClass3()
        {
        }
        public static NumberingClass3 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass3();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[1].NumberStyle = WdListNumberStyle.wdListNumberStyleUppercaseRoman;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[1].TextPosition = appWord.InchesToPoints(0.5f);
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[1].TabPosition = appWord.InchesToPoints(0.5F);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[2].NumberStyle = WdListNumberStyle.wdListNumberStyleUppercaseLetter;
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[2].NumberPosition = appWord.InchesToPoints(0.5f);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[2].TextPosition = appWord.InchesToPoints(1);
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[2].TabPosition = appWord.InchesToPoints(1);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].TextPosition = appWord.InchesToPoints(1.5F);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].Font.AllCaps = (int)WdConstants.wdUndefined;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].NumberPosition = appWord.InchesToPoints(1.5f);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].TextPosition = appWord.InchesToPoints(2);
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].TabPosition = appWord.InchesToPoints(2);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].Font.AllCaps = (int)WdConstants.wdUndefined;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[5].Font.Bold = (int)WdConstants.wdUndefined;
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[5].Font.Italic = (int)WdConstants.wdUndefined;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[6].NumberStyle = WdListNumberStyle.wdListNumberStyleLowercaseRoman;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[7].NumberStyle = WdListNumberStyle.wdListNumberStyleNone;
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[7].NumberPosition = appWord.InchesToPoints(0);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[7].TextPosition = appWord.InchesToPoints(0);
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[7].TabPosition = appWord.InchesToPoints(0);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[7].Font.Italic = (int)WdConstants.wdUndefined;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[9].NumberStyle = WdListNumberStyle.wdListNumberStyleNone;
