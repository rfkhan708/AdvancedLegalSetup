...
{
    public class NumberingClass20
    {
        private static NumberingClass20 instance = null;
        private NumberingClass20()
        {
        }
        public static NumberingClass20 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass20();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[1].TextPosition = appWord.InchesToPoints(1.5f);
