...
{
    public class NumberingClass15
    {
        private static NumberingClass15 instance = null;
        private NumberingClass15()
        {
        }
        public static NumberingClass15 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass15();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].Font.Bold = (int)GlobalEnumClass.AllEnum.True;
