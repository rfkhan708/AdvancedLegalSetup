...
{
    public class NumberingClass21
    {
        private static NumberingClass21 instance = null;
        private NumberingClass21()
        {
        }
        public static NumberingClass21 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass21();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading2].Font.Italic = (int)GlobalEnumClass.AllEnum.True;
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading2].Font.Underline = WdUnderline.wdUnderlineSingle;
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[2].TextPosition = appWord.InchesToPoints(0.5f);
