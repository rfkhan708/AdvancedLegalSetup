...
{
    public class NumberingClass1
    {
        private static NumberingClass1 instance = null;
        private NumberingClass1()
        {
        }
        public static NumberingClass1 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass1();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                // var _with1 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading1];
                ...
                //.BaseStyle = "Normal"
                //_with1.NextParagraphStyle = GlobalEnumClass.Heading1;      doubt
                ...
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading1].Font.Bold = (int)GlobalEnumClass.AllEnum.False;
                ...
                //var _with2 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading2];
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                object setStyle2 = GlobalEnumClass.Heading2;
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading2].set_NextParagraphStyle(ref setStyle2);
                ...
                //var _with3 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading3];
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                object setStyle3 = GlobalEnumClass.Heading3;
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading3].set_NextParagraphStyle(ref setStyle3);
                ...
                //var _with4 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading4];
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                object setStyle4 = GlobalEnumClass.Heading4;
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading4].set_NextParagraphStyle(ref setStyle4);
                ...
                //var _with5 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading5];
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                object setStyle5 = GlobalEnumClass.Heading5;
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading5].set_NextParagraphStyle(ref setStyle5);
                ...
                //var _with6 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading6];
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                object setStyle6 = GlobalEnumClass.Heading6;
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading6].set_NextParagraphStyle(ref setStyle6);
                ...
                //var _with7 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading7];
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                ...
                //var _with8 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading8];
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                object setStyle8 = "Body Text";
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading8].set_NextParagraphStyle(ref setStyle8);
                ...
                //var _with9 = appWord.ActiveDocument.Styles[GlobalEnumClass.Heading9];
                appWord.ActiveDocument.UpdateStylesOnOpen = false;
                object setStyle9 = "Body Text";
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading9].set_NextParagraphStyle(ref setStyle9);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[1].NumberPosition = appWord.InchesToPoints(1);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[1].TabPosition = appWord.InchesToPoints(1.5F);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[1].Font.Bold = (int)GlobalEnumClass.AllEnum.False;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].TabPosition = appWord.InchesToPoints(2.0F);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].NumberStyle = WdListNumberStyle.wdListNumberStyleLowercaseRoman;
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[4].NumberPosition = appWord.InchesToPoints(2);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[5].TextPosition = appWord.InchesToPoints(0);
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[6].TextPosition = appWord.InchesToPoints(0);
                ...
                //appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[8].TrailingCharacter = WdTrailingCharacter.wdTrailingTab;
                // appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[8].NumberStyle = WdListNumberStyle.wdListNumberStyleUppercaseLetter;
                ...
                //appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[9].TrailingCharacter = WdTrailingCharacter.wdTrailingTab;
                //appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[9].NumberStyle = WdListNumberStyle.wdListNumberStyleUppercaseLetter;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[9].Font.DoubleStrikeThrough = (int)GlobalEnumClass.AllEnum.False;
