...
{
    public class NumberingClass17
    {
        private static NumberingClass17 instance = null;
        private NumberingClass17()
        {
        }
        public static NumberingClass17 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass17();
                }
                return instance;
            }
        }
