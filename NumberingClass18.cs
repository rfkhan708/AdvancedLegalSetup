...
{
    public class NumberingClass18
    {
        private static NumberingClass18 instance = null;
        private NumberingClass18()
        {
        }
        public static NumberingClass18 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass18();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ActiveDocument.Paragraphs.Alignment = WdParagraphAlignment.wdAlignParagraphCenter;
                ...
                appWord.ListGalleries[WdListGalleryType.wdOutlineNumberGallery].ListTemplates[6].ListLevels[3].StartAt = 2;
