...
{
   public class NumberingClass13
    {
        private static NumberingClass13 instance = null;
        private NumberingClass13()
        {
        }
        public static NumberingClass13 Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new NumberingClass13();
                }
                return instance;
            }
        }
        ...
        public void FormatNumbering()
        {
            ...
            try
            {
                ...
                appWord.ActiveDocument.Styles[GlobalEnumClass.Heading1].Font.AllCaps = (int)GlobalEnumClass.AllEnum.True;
